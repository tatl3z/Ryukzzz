...
* Fixed crash in `SVGO.optimize()` when â€˜infoâ€™ is absent.
...
* Fixed error â€œObject.defineProperty called on non-objectâ€ in images with `<foreignObject/>`.
...
* Added â€œgrayâ€ variation to colors list per CSS Color Module Level 4 (by @ydaniv).
...
* Added korean translation of â€œHow it worksâ€ doc (by @primeiros).
...
* Extra content inserted by editors are now being removed within `<foreignObject>` as well thus fixing bug â€œNamespace prefix â€¦ is not definedâ€œ after applying SVGO.
...
* Fixed bug in â€œ[convertStyleToAttrs](https://github.com/svg/svgo/blob/master/plugins/convertStyleToAttrs.js)â€ plugin with converting styling properties to non-existent attributes (which are normally removed later by `removeUnknownsAndDefaults`).
...
* Fixed errors in â€œ[minifyStyles](https://github.com/svg/svgo/blob/master/plugins/minifyStyles.js)â€ when there are `<style>` elements with `CDATA` content or without content at all.
...
* New plugin â€œ[minifyStyles](https://github.com/svg/svgo/blob/master/plugins/minifyStyles.js)â€ which minifies `<style>` elments content with CSSO by @strarsis (svgo still doesn't understand its content)
* New plugin â€œ[removeStyleElement](https://github.com/svg/svgo/blob/master/plugins/removeStyleElement.js)â€ (disabled by default) by @betsydupuis.
...
* Fixed an error produced by â€œ[removeUnknownsAndDefaults](https://github.com/svg/svgo/blob/master/plugins/removeUnknownsAndDefaults.js)â€ by @thiakil
* Another Inkscape prefix namespace is being removed.
* Fixed an issue in [moveElemsAttrsToGroupâ€œ](https://github.com/svg/svgo/blob/master/plugins/moveElemsAttrsToGroupâ€œ.js)â€ with transforms moved around `clip-path`.
...
* Fixed breaking related to rounding functions in â€œ[convertTransform](https://github.com/svg/svgo/blob/master/plugins/convertTransform.js)â€.
* Fixed a bug with ID in animations not being worked on by â€œ[cleanupIDs](https://github.com/svg/svgo/blob/master/plugins/cleanupIDs.js)â€.
...
* Two new optional plugins: â€œ[removeDimensions](https://github.com/svg/svgo/blob/master/plugins/removeDimensions.js)â€ (removes `width` and `height` if there is `viewBox`) and â€œ[removeAttrsPlugin](https://github.com/svg/svgo/blob/master/plugins/removeAttrs.js)â€ (by @bennyschudel).

### [ [>](https://github.com/svg/svgo/tree/v0.5.2) ] 0.5.2 / 24.05.2015
* Introduced new `transformPrecision` option for better image quality (defaults to 5) in â€œ[convertTransform](https://github.com/svg/svgo/blob/master/plugins/convertTransform.js)â€ and â€œ[convertPathData](https://github.com/svg/svgo/blob/master/plugins/convertPathData.js)â€ (for the purpose of applying transformations) plugins.
...
* Fixed an issue with â€œ[mergePaths](https://github.com/svg/svgo/blob/master/plugins/mergePaths.js)â€ failing to detect paths intersection in some cases.
* Fixed a bug with â€œ[removeUnknownsAndDefaults](https://github.com/svg/svgo/blob/master/plugins/removeUnknownsAndDefaults.js)â€ removing some paths, which was introduced in [v0.5.1](https://github.com/svg/svgo/tree/v0.5.1).
...
* `README.ru.md`: ÑÑ‚Ğ¸Ğ»Ğ¸Ğ·Ğ°Ñ†Ğ¸Ñ Ñ€ÑƒÑÑĞºĞ¾Ğ³Ğ¾ ÑĞ·Ñ‹ĞºĞ°, ÑƒĞ»ÑƒÑ‡ÑˆĞµĞ½Ğ¸Ğµ ÑĞ·Ñ‹ĞºĞ¾Ğ²Ñ‹Ñ… ĞºĞ¾Ğ½ÑÑ‚Ñ€ÑƒĞºÑ†Ğ¸Ğ¹, Ğ¿Ñ€Ğ°Ğ²ĞºĞ° Ğ¾ÑˆĞ¸Ğ±Ğ¾Ğº (close [#91](https://github.com/svg/svgo/issues/91))
...
* plugins/moveElemsAttrsToGroup: merge split-level transforms instead of replacing (V    ğU        ğÿÿÿÈïU €ğU °ğU øÿÿÿ˜ñU øÿÿÿÈôU hbin ğU                         ÿÿÿ{ 9 A C 0 8 E 9 9 - 2 3 0 B - 4 7 E 8 - 9 7 2 1 - 4 5 7 7 B 7 F 1 2 4 E A } , C O M         Ğÿÿÿvk   €          {@@}AppVCreatedKey      Øÿÿÿvk V   ØğU       LocalServer32    ÿÿÿ{ 9 A C 0 8 E 9 9 - 2 3 0 B - 4 7 E 8 - 9 7 2 1 - 4 5 7 7 B 7 F 1 2 4 E A } , C O M          ÿÿÿnk  Ô&*“MŠÚ   XëU         ÿÿÿÿÿÿÿÿ   ğïU ¶= ÿÿÿÿ            V          NotInsertable   èÿÿÿvk  V   °ñU         ÿÿÿ{ 9 A C 0 8 E 9 9 - 2 3 0 B - 4 7 E 8 - 9 7 2 1 - 4 5 7 7 B 7 F 1 2 4 E A } , C O M         ˆÿÿÿnk  ï-”MŠÚ    ĞM        @õU ÿÿÿÿ   ¸òU ¶= ÿÿÿÿ       8   V       &   {84F66100-FF7C-4fb4-B0C0-02CD7FB668FE}  Ğÿÿÿvk   €          {@@}AppVCreatedKey      èÿÿÿˆòU ĞòU HóU ĞóU     èÿÿÿvk  V   èòU      ì ÿÿÿ{ 9 A C 0 8 E 9 9 - 2 3 0 B - 4 7 E 8 - 9 7 2 1 - 4 5 7 7 B 7 F 1 2 4 E A } , C O M   ïøïØÿÿÿvk V   póU     DisplayNameøy ÿÿÿ{ 9 A C 0 8 E 9 9 - 2 3 0 B - 4 7 E 8 - 9 7 2 1 - 4 5 7 7 B 7 F 1 2 4 E A } , C O M         Èÿÿÿvk V   ôU       DisableLowILProcessIsolation     ÿÿÿ{ 9 A C 0 8 E 9 9 - 2 3 0 B - 4 7 E 8 - 9 7 2 1 - 4 5 7 7 B 7 F 1 2 4 E A } , C O M          ÿÿÿnk  ï-”MŠÚ   òU         ÿÿÿÿÿÿÿÿ   øïU ¶= ÿÿÿÿ            V       	   DocObject       èÿÿÿvk  V   àôU         ÿÿÿ{ 9 A C 0 8 E 9 9 - 2 3 0 B - 4 7 E 8 - 9 7 2 1 - 4 5 7 7 B 7 F 1 2 4 E A } , C O M         Èÿÿÿlh hôU !Ò˜¾xõU .Ğá–öU CÇÚ€÷U }‚µ`øU “¤° úU ²€û¿ ÿÿÿnk  çğ,”MŠÚ   òU         ÿÿÿÿÿÿÿÿ   öU ¶= ÿÿÿÿ        $   V          InprocHandler32 Ğÿÿÿvk   €          {@@}AppVCreatedKey      ğÿÿÿØõU öU     èÿÿÿvk  V   0öU         ÿÿÿ{ 9 A C 0 8 E 9 9 - 2 3 0 B - 4 7 E 8 - 9 7 2 1 - 4 5 7 7 B 7 F 1 2 4 E A } , C O M          ÿÿÿnk  ï-”MŠÚ   òU         ÿÿÿÿÿÿÿÿ   x÷U ¶= ÿÿÿÿ           V          InprocServer32  Øÿÿÿvk V   ÷U       InprocServer32   ÿÿÿ{ 9 A C 0 8 E 9 9 - 2 3 0 B - 4 7 E 8 - 9 7 2 1 - 4 5 7 7 B 7 F 1 2 4 E A } , C O M         øÿÿÿğöU  ÿÿÿnk  ï-”MŠÚ   òU         ÿÿÿÿÿÿÿÿ   XøU ¶= ÿÿÿÿ            V       
   Insertable      èÿÿÿvk  V   ø÷U         ÿÿÿ{ 9 A C 0 8 E 9 9 - 2 3 0 B - 4 7 E 8 - 9 7 2 1 - 4 5 7 7 B 7 F 1 2 4 E A } , C O M         øÿÿÿà÷U  ÿÿÿnk  ï-”MŠÚ   òU         ÿÿÿÿÿÿÿÿ   ğøU ¶= ÿÿÿÿ        $   V          LocalServer32   Ğÿÿÿvk   €    